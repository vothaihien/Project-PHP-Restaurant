            ...
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card shadow">
                    ...
                    <div class="table-responsive" data-toggle="list"
                        data-list-values='["ordered_at", "status", "restaurant", "user", "city"]'>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <span
                                                ...
                                                {{ str_replace('_', ' ', optional($order->status->first())->status ?? 'unknown') }}
                                            </span>
                                        </th>
                                        <td>
                                        ...
                                        <td>
                                            {{ App\Models\Address::getCity($order->user->id) }}
                                        </td>
                                        <td>
                                            <button class="btn btn-sm" data-toggle="tooltip"
                                                onclick="window.location ='{{route('pigeon.orderDetails', $order->id)}}'">
