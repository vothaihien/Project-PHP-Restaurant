...
<div class="header pb-8 pt-5 pt-lg-8 d-flex"
    style="background-image: url('/public/storage/{{ $restaurant->image }}'); background-size: cover; background-position: center center;">
    <!-- Mask -->
            ...
            <div class="row">
                ...
                <div class="col-xl-12 mb-xl-0">
                    <div class="card shadow border-danger">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('pigeon.setTempPass', $restaurant->slug) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Set Temporary Password"
                                        name="temp_pass">
                ...
                <div class="col-lg-4">
                    <div class="card bg-gradient-info border-0">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0 text-white">Feedback / Reviews
                                    </h5>
                                    <span class="h1 font-weight-bold mb-0 text-white">{{ $reviewsAvg }}/5</span>
                                </div>
                                <div class="col-auto">
                            ...
                            <p class="mt-3 mb-0 text-sm">
                                <span class="text-white mr-2 h4">{{ $reviewsCount }}</span>
                                <span class="text-nowrap text-light">Customer Reviews</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card bg-gradient-green border-0">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0 text-white">Total Menu Items
                                    </h5>
                                    <span class="h1 font-weight-bold mb-0 text-white">{{$menu_items}}</span>
                                </div>
                                <div class="col-auto">
                                    <div class="icon icon-shape bg-white text-dark rounded-circle shadow">
                                        <i class="ni ni-basket"></i>
                    ...
                    <div class="card shadow">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <ul class="nav nav-pills justify-content-end">
                                        <span
                                            class="badge @if($restaurant->active) badge-success @else badge-danger @endif">{{$restaurant->getStatus()}}</span>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <dl class="dl-horizontal">
                                ...
                                <dd>{{$restaurant->address->city}}, {{$restaurant->address->province}},
                                    {{$restaurant->address->country}}</dd>
        ...
        <div class="col-xl-4 mb-xl-0">
            <div class="card shadow h-100">
                ...
                <div class="card-body">
                    ...
                    @for($i = 1; $i < 8; $i++) <div
                        class="d-flex justify-content-between @if($i === \App\Models\RestaurantHours::today()) today @endif align-items-center py-2">
                        <h4 class="mb-0">{{\App\Models\RestaurantHours::dayFromNumber($i) }}: </h4>
                        <p class="mb-0">{{\App\Models\RestaurantHours::displayHours($restaurant->id, $i)}}</p>
                </div>
                @endfor
                @else
    ...
    <div class="col-xl-12 mb-xl-0">
        <div class="card shadow border-danger">
            <div class="card-body button-container">
                <form method="POST" action="{{ route('pigeon.activateRestaurant', $restaurant->slug) }}"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    {!!
                        ...
                        <div class="modal-content bg-gradient-danger">
                            ...
                            <div class="modal-body">
                                <div class="py-3 text-center">
                                    ...
                                    <p>Deleting this restaurant cannot be reversed! All associated items will also
                                        be permanently deleted (Address, Menu Items).</p>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <form method="POST" action="{{ route('pigeon.delRestaurant', $restaurant->slug) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('DELETE')
