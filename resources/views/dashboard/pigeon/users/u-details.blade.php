                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <dl class="dl-horizontal pl-lg-4 w-50" style="float: left;display: inline-block">
                                ...
                                <dd>{{$user->phone}}</dd>
                                <dt>City</dt>
                                <dd>{{App\Models\Address::getCity($user->id)}}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                    <div class="modal-content bg-gradient-danger">
                                        <div class="modal-header">
                                            <h6 class="modal-title" id="modal-title-delete">Your attention is required
                                            </h6>
                                        ...
                                        <div class="modal-footer">
                                            <form method="POST" action="{{ route('pigeon.delUser', $user->id) }}"
            ...
            <div class="card shadow h-100">
                ...
                <div class="card-body p-0">
                    <div class="list-group">
                        ...
                        <a href="{{ route('pigeon.orderDetails', $order->id) }}"
                            class="list-group-item list-group-item-action">
                            #{{ $order->id . ' | ' . Carbon\Carbon::parse($order->created_at)->toDayDateTimeString() }}
                            <span
                                class="badge {{ optional($order->status->first())->getColor() ?? 'badge-secondary' }} float-right">{{ optional($order->status->first())->status ?? 'unknown' }}</span>
                        </a>
                        @empty
