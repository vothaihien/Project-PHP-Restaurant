...
<div class="container pt-4">
                ...
                <div>
                    <div class="card_slide">
                        ...
                        <div class="card_slide__text">
                            <a href="{{ route('home.show', $fav->slug) }}" class="none">
                                <p>{{ $fav->name }}</p>
                            </a>
                        </div>
                    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <h2><span class="highlight-container-y"><span class="highlight">{!! $title !!}</span></span></h2>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-4">
        <div class="col-12 d-flex justify-content-center">
            {{ $restaurants->appends(request()->input())->links('vendor.pagination.bootstrap-5') }}
        </div>
    </div>
</div>
@endsection
...
@endif
@if(!Session::has('address'))
<script src="{{ asset('js/geocoder.js') }}"></script>@endif
@endsection